...
Revision ID: 90bf367c4abd
Revises: 
Create Date: 2018-10-06 16:25:13.619891
...
def upgrade():
    ...
    op.create_index(op.f('ix_annotation_version_active'), 'annotation_version', ['active'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_annotation_version_active'), table_name='annotation_version')
