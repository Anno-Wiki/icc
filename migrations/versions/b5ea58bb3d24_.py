...
Revision ID: b5ea58bb3d24
Revises: 
Create Date: 2018-07-07 15:35:23.340624
...
def upgrade():
    ...
    op.create_index(op.f('ix_author_birth_year'), 'author', ['birth_year'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_author_birth_year'), table_name='author')
